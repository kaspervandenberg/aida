 ...
 * To run this client, use <code>http://localhost/LearnModel/learn</code>
 * <p>
 * Note: do not forget to check whether Tomcat uses the same port as in 
 * <code>String endpoint = "http://localhost/axis/services/LearnModel";</code>. 
 * Change it if needed.
 * <p>
...
public class LearnModelServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String ret=new String();ret = "<doc>Please check your training data set once again!</doc>";
         try {
             String endpoint = "http://localhost/axis/services/LearnModel";
