...
public final class result extends HttpServlet {
    ...
    private         Call        call;
    private final   String      endpoint = "http://localhost:8080/axis/services/";
            ...
            for (int j=0 ; j<doc.length ; ++j) {
                ...
                for (int i=0;i<fields.length;++i) {    
                    ...
                    if (fields[i].getName().equalsIgnoreCase("id") || fields[i].getName().equalsIgnoreCase("pmid")) {
                      url = "http://localhost:8080/search/item?index=" +
                ...
                if (sentenceIndex) {
                    out.println("          <tr>");
                    out.println("            <td colspan=2 width=200px>");
                    //http://localhost:8080/search/sentence?pmid=10901326&offset=3449&length=533
