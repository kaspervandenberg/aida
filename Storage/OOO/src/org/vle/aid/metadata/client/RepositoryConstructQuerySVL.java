 ...
 * @version
 */
public class RepositoryConstructQuerySVL extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            call.setOperationName("constructQuery");
            ...
            String s = (String) call.invoke( new Object[] { 
                    ...
                    ((String[])param.get("query_language"))[0], ((String[])param.get("rdf_format"))[0],
                    ((String[])param.get("query"))[0]
                } );
            out.println("<h2>returned</h2>" + s);
