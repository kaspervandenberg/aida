 ...
 * @version
 */
public class RepositoryRemoveRdfFileSVL extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            call.setOperationName("removeRdfFile");
            ...
            Boolean b = (Boolean) call.invoke( new Object[] { 
                    ...
                    ((String[])param.get("rdf_format"))[0], 
                    ((String[])param.get("data_uri"))[0]
                } );
