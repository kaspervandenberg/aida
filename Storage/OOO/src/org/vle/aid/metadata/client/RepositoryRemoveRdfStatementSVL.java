 ...
 * @version
 */
public class RepositoryRemoveRdfStatementSVL extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            Boolean b = null;
            if (param.get("context") != null && ((String[])param.get("context"))[0] != null) {
                if (!((String[])param.get("context"))[0].equals("")) {
                    ...
                    b = (Boolean) call.invoke( new Object[] { 
                        ...
                        ((String[])param.get("subject"))[0], 
                        ((String[])param.get("predicate"))[0],
                        ((String[])param.get("object"))[0],
                        ((String[])param.get("context"))[0]
                    } );
                } else {
                }
            }
