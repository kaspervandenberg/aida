...
public class BasicQueries
{
    ...
    private static String _queryLanguage = queryLanguageSPARQL;    // default language
    ...
    {
        if (repository_server != null)
        {
            _repository_server = repository_server;
        }
        if (repository_name != null)
        {
            _repository_name = repository_name;
        }
        if (repository_user != null)
        {
            _repository_user = repository_user;
        }
        if (repository_password != null)
        {
            _repository_password = repository_password;
        }
    ...
    private boolean removeStatement(String subject, String predicate, String object) throws RemoveRDFException
    {
        boolean result = true;
        if (object == null || object.length() == 0)
        {
    ...
    private String queryObject(String subject, String predicate) throws QueryException
    {
        String query = null;
        if (_queryLanguage.equalsIgnoreCase(queryLanguageSERQL))
        {
        ...
        else if (_queryLanguage.equalsIgnoreCase(queryLanguageSPARQL))
        {
        ...
        if (resultTable == null || resultTable.length < 1)
        {
            return null;
        }
    ...
    private String[] queryObjectList(String subject, String predicate, boolean stripNamespace) throws QueryException
    {
        String query = null;
        if (_queryLanguage.equalsIgnoreCase(queryLanguageSERQL))
        {
    ...
    private String[] queryEntityList(String entityType, boolean stripNamespace) throws QueryException
    {
        String query = null;
        if (_queryLanguage.equalsIgnoreCase(queryLanguageSERQL))
        {
    ...
    private String[][] queryStatementsInModel() throws QueryException
    {
        String query = null;
        if (_queryLanguage.equalsIgnoreCase(queryLanguageSERQL))
        {
        ...
        {
            query = "PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#> " +
                    "select distinct ?SUBJECT ?PRED ?OBJECT " +
                    "where {" +
                    "?TRIPLE rdf:subject  ?SUBJECT . " +
                    "?TRIPLE rdf:predicate ?PRED . " +
                    "?TRIPLE rdf:object  ?OBJECT . " +
    ...
    public String exportRepositoryXml() throws ExtractRdfException
    {
    ...
    public String[][] selectQuery(String query, String queryLanguage) throws QueryException
    {
    ...
    public boolean deleteModel() throws QueryException, RemoveRDFException
    {
        boolean res = true;
    ...
    public void addAnnotation(Annotation anno) throws RepositoryAccessException, AddRdfException
    {
    ...
    public Annotation getAnnotation(String annotationUri) throws QueryException
    {
    ...
    public String[] getAnnotations() throws QueryException
    {
        return queryEntityList(type_annotation, false);
    }

    public boolean removeAnnotation(Annotation anno) throws RemoveRDFException
    {
    ...
    public boolean removeAnnotation(String annotationUri) throws QueryException, RemoveRDFException
    {
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addBiCadObject(BiCadObject obj) throws RepositoryAccessException, AddRdfException
    {
    ...
    public BiCadObject getBiCadObject(String objectUri) throws QueryException
    {
...
//            return null;
    ...
    public String[] getBiCadObjects() throws QueryException {
        return queryEntityList(type_object, false);
    }

    public boolean removeBiCadObject(BiCadObject obj) throws RemoveRDFException {
        return removeBiCadObject(obj.getBiCadObjectUri(), obj.getAnnotationUris(),
                obj.getDisplayNameLit());
    }

    public boolean removeBiCadObject(String objectUri) throws QueryException, RemoveRDFException {
    ...
    public boolean removeBiCadObject(String objectUri, String[] annoUris, String dispNameLit) throws RemoveRDFException {
        boolean succeed = true;
    ...
    public boolean removeAnnotationFromBiCadObject(String objectUri, String annoUri) throws RemoveRDFException {
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addConcept(Concept concept) throws RepositoryAccessException, AddRdfException {
    ...
    public Concept getConcept(String conceptUri) throws QueryException {
    ...
    public String[] getConcepts() throws QueryException {
        return queryEntityList(type_concept, false);
    }

    public boolean removeConcept(Concept concept) throws RemoveRDFException {
        return removeConcept(concept.getConceptUri(), concept.getPropertyUris(),
                concept.getDisplayNameLit());
    }

    public boolean removeConcept(String conceptUri) throws QueryException, RemoveRDFException {
    ...
    public boolean removeConcept(String conceptUri, String[] propUris, String dispNameLit) throws RemoveRDFException {
        boolean succeed = true;
    ...
    public boolean removePropertyFromConcept(String conceptUri, String propUri) throws RemoveRDFException {
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addConceptRelation(ConceptRelation rel) throws RepositoryAccessException, AddRdfException {
    ...
    public ConceptRelation getConceptRelation(String conRelUri) throws QueryException {
        String[] objUris = null;
...
//            return null;
    ...
    public String[] getConceptRelations() throws QueryException {
        return queryEntityList(type_conceptRelation, false);
    }

    public boolean removeConceptRelation(ConceptRelation rel) throws RemoveRDFException {
        return removeConceptRelation(rel.getConceptRelationUri(), rel.getSubjectUri(),
                rel.getRelationTypeUri(), rel.getDisplayNameLit(), rel.getObjectUris());
    }

    public boolean removeConceptRelation(String conRelUri) throws QueryException, RemoveRDFException {
    ...
    public boolean removeConceptRelation(String conRelUri, String subjUri, String relTypeUri, String dispNameLit, String[] objUris) throws RemoveRDFException {
        boolean succeed = true;
    ...
    public boolean removeObjectFromConceptRelation(String conRelUri, String objUri) throws RemoveRDFException {
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addDocument(Document doc) throws RepositoryAccessException, AddRdfException {
    ...
    public Document getDocument(String documentUri) throws QueryException {
    ...
    public String[] getDocuments() throws QueryException {
        return queryEntityList(type_document, false);
    }

    public boolean removeDocument(Document doc) throws RemoveRDFException {
        return removeDocument(doc.getDocumentUri(), doc.getOrigDocLit(),
                doc.getDisplayDocLit(), doc.getTextDocLit(),
                doc.getDisplayNameLit());
    }

    public boolean removeDocument(String documentUri) throws QueryException, RemoveRDFException {
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addLocation(Location loc) throws RepositoryAccessException, AddRdfException {
...
//throw new RepositoryAccessException("Test error generated in addLocation");
    ...
    public Location getLocation(String locationUri) throws QueryException {
    ...
    public String[] getLocationss() throws QueryException {
        return queryEntityList(type_location, false);
    }

    public boolean removeLocation(Location loc) throws RemoveRDFException {
        return removeLocation(loc.getLocationUri(), loc.getDocumentUri(),
                loc.getPositionLit(), loc.getDisplayNameLit());
    }

    public boolean removeLocation(String locationUri) throws QueryException, RemoveRDFException {
        Location loc = getLocation(locationUri);
        return removeLocation(loc);
    }

    public boolean removeLocation(String locationUri, String documentUri, String posLit, String dispNameLit) throws RemoveRDFException {
        boolean succeed = true;
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addObjectRelation(ObjectRelation rel) throws RepositoryAccessException, AddRdfException {
    ...
    public ObjectRelation getObjectRelation(String objRelUri) throws QueryException {
        String[] objUris = null;
        String subjUri = null, relTypeUri = null, dispName = null;
...
//        return new ObjectRelation(objRelUri, subjUri, objUris, relTypeUri, dispName);
        ...
        if (or == null) {
            System.out.println("BQ.getObRel(): new ObjectRelation() returns null");
        } else {
            System.out.println("BQ.getObRel(): new ObjectRelation() succeeded");
        }
        return or;
    }

    public String[] getObjectRelations() throws QueryException {
        return queryEntityList(type_objectRelation, false);
    }

    public boolean removeObjectRelation(ObjectRelation rel) throws RemoveRDFException {
        return removeObjectRelation(rel.getObjectRelationUri(), rel.getSubjectUri(), rel.getObjectUris(),
                rel.getRelationTypeUri(), rel.getDisplayNameLit());
    }

    public boolean removeObjectRelation(String objRelUri) throws QueryException, RemoveRDFException {
    ...
    public boolean removeObjectRelation(String objRelUri, String subjUri, String[] objUris, String relTypeUri, String dispNameLit) throws RemoveRDFException {
        boolean succeed = true;
    ...
    public boolean removeObjectFromObjectRelation(String objRelUri, String objUri) throws RemoveRDFException {
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addProperty(Property prop) throws RepositoryAccessException, AddRdfException {
    ...
    public Property getProperty(String propUri) throws QueryException {
        String dispName = queryObject(propUri, ns_rdf + pred_label);
//        if (dispName == null) return null;
        return new Property(propUri, dispName);
    }

    public String[] getProperties() throws QueryException {
        return queryEntityList(type_property, false);
    }

    public boolean removeProperty(Property prop) throws RemoveRDFException {
        return removeProperty(prop.getPropertyUri(), prop.getDisplayNameLit());
    }

    public boolean removeProperty(String propUri) throws QueryException, RemoveRDFException {
    ...
    public boolean removeProperty(String propUri, String dispNameLit) throws RemoveRDFException {
        boolean succeed = true;
    ...
    /**
     * @throws AddRdfException *******************************************/
    public void addSelectionRule(SelectionRule rule) throws RepositoryAccessException, AddRdfException {
    ...
    public SelectionRule getSelectionRule(String ruleUri) throws QueryException {
...
//            return null;
    ...
    public String[] getSelectionRules() throws QueryException {
        return queryEntityList(type_selectionRule, false);
    }

    public boolean removeSelectionRule(SelectionRule rule) throws RemoveRDFException {
        return removeSelectionRule(rule.getSelectionRuleUri(), rule.getQueryLit(),
                rule.getQueryLanguageLit(), rule.getDisplayNameLit());
    }

    public boolean removeSelectionRule(String ruleUri) throws QueryException, RemoveRDFException {
    ...
    public boolean removeSelectionRule(String ruleUri, String queryLit, String queryLangLit, String dispNameLit) throws RemoveRDFException {
        boolean succeed = true;
//System.out.println("removing SelectionRule "+ruleUri+"\t"+queryLangLit+"\t"+dispNameLit+"\t"+queryLit);        
    ...
    public String[][] executeSelectionRule(String ruleUri) throws RemoteException {
