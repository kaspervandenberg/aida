...
public class AutoCompletionSVL extends HttpServlet
{
    ...
    {
        if (ns.startsWith("http://www.w3.org/2004/02/skos")) 
        {
            return "skos";
        }
        else if (ns.startsWith("http://www.w3.org/1999/02/22-rdf-syntax-ns"))
        {
            return "rdf";
        }
        else if (ns.startsWith("http://www.w3.org/2000/01/rdf-schema"))
        {
            return "rdfs";
        }
        else if (ns.startsWith("http://www.w3.org/2002/07/owl"))
        {
            return "owl";
        }
        else if (ns.startsWith("http://www.w3.org/2001/XMLSchema"))
        {
            return "xs";
        }
        else if (ns.startsWith("http://purl.org/dc/elements"))
        {
            return "dc";
        }
        else if (ns.startsWith("http://xmlns.com/foaf"))
        {
            return "foaf";
        }
        else if (ns.startsWith("http://agclass.nal.usda.gov/"))
        {
            return "nal";
        }
        else if (ns.startsWith("http://www.fao.org/"))
        {
            return "fao";
        }
        else if (ns.startsWith("http://www.vl-e.nl/aid"))
        {
            return "aid";
        }
        else if (ns.startsWith("http://www.tno.nl/ns/bicad") ||
                ns.startsWith("http://www.few.vu.nl/~wrvhage/ns/bicad"))
        {
            return "tno";
        }
        return ns;
            ...
            throws ServletException, IOException
    {
        ...
        if (param.get("matchAnywhere") != null && ((String[]) param.get("matchAnywhere"))[0].equalsIgnoreCase("true"))
        {
            matchAnywhere = "*";
        }
        String ignoreCase = " ignore case ";
        if (param.get("ignoreCase") != null && ((String[]) param.get("ignoreCase"))[0].equalsIgnoreCase("true"))
        {
            ignoreCase = "";
        }
        int limit = 5;
