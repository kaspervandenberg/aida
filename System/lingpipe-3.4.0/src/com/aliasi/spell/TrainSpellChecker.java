 ...
 * @since   LingPipe2.0
 */
public class TrainSpellChecker implements Compilable, TextHandler, Serializable  {
     ...
     * count.
     *
     * <p>See the method {@link #train(CharSequence)} for information
     * on the normalization carried out on the input character
     * sequence.
     *
     * <p>Although calling this method is equivalent to calling {@link
     * #train(CharSequence)} the specified count number of times, this
    ...
    /**
     * Train the spelling checker on the specified character slice.
     * This method implements the necessary method for the {@link
     * TextHandler} interface.  Otherwise, it behaves exactly the same
     * way as {@link #train(CharSequence)}.
     *
    ...
    public void handle(char[] cs, int start, int length) {
        train(new String(cs,start,length));
    }
    ...
    static class Serializer extends AbstractExternalizable {
        ...
        public Object read(ObjectInput objIn)
            ...
            if (tokenizing) {
                ...
                tokenCounter = (ObjectToCounterMap<String>) objIn.readObject();
            }
            WeightedEditDistance editDistance
                = (WeightedEditDistance) objIn.readObject();
