...
public class SpellCheckerTest extends BaseTestCase {
    ...
    for (int i = 0; i < 1000; ++i) 
        trainer.train("abc DEF gHiJk lm");
    ...
    for (int i = 0; i < 1000; ++i) {
        // trainer.train("abracadabra ");
        trainer.train("abracadabra abracadabra abracadabra");
    }
