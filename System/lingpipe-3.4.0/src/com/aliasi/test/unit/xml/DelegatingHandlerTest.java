...
public class DelegatingHandlerTest extends BaseTestCase {
    ...
    public void testOne() throws IOException, SAXException {
        ...
        assertEqualsArray(expectedAValue,testHandler.aValue());
        assertEqualsArray(expectedBValue,testHandler.bValue());
    }
